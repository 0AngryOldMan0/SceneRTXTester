...
static_assert(sizeof(EmissiveTriangleGPUCPU) == 16, "EmissiveTriangleGPUCPU size must be 16 bytes");
...
static std::vector<EmissiveTriangleGPUCPU> BuildEmissiveTriangleTable(const std::vector<Triangle> &tris)
{
    ...
    for (std::size_t i = 0; i < tris.size(); ++i)
    {
        ...
        const float area = TriangleAreaCPU(t);
                             ...
                             std::vector<Vec3>           &framebuffer)
{
    ...
    @autoreleasepool
    {
        ...
        const std::vector<EmissiveTriangleGPUCPU> emissiveTrianglesCPU = BuildEmissiveTriangleTable(tris);
